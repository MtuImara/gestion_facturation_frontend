<?php
    ...
    $ch = curl_init();
    $url = "https://spectacular-reprieve-production.up.railway.app/facturation/api/rapport_bon_de_commande/";
...
<body>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                <h3 class="box-title m-b-0">Rapport des Bons de Commande</h3>
                ...
                <div class="table-responsive">
                    <table id="example23" class="table table-striped">
                        ...
                        <tbody>
                            <?php 
                                foreach ($datas["data"]["rapportBonDeCommande"] as $repository){

                                    foreach ($repository["bonDeCommandeDetail"] as $detail){
                            ?>
                            <tr>
                                <td><?= htmlspecialchars($detail["bonDeCommande"]["dateOperation"]) ?></td>
                                <td><?= htmlspecialchars($detail["bonDeCommande"]["code"]) ?></td>
                                ...
                                <td><?= htmlspecialchars($detail["bonDeCommande"]["etat"]) ?></td>                              
