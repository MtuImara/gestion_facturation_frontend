...
<?php
    ...
    $id = $_GET["id"];
    $ch = curl_init();
    $url = "https://spectacular-reprieve-production.up.railway.app/facturation/api/gestion_de_bon_de_livraison/$id";
...
<?php
    ...
    $ch = curl_init();
    $url = "https://spectacular-reprieve-production.up.railway.app/facturation/api/gestion_de_services/service_detail";
...
?>
            ...
            <div class="white-box">
                ...
                <div class="table-responsive">
                    <table class="table color-table primary-table">
                        ...
                        <?php 
                            $i=0;
                            foreach ($datas["data"]["bonDeLivraisonDetail"] as $repository): 
                            $i++;
                        ?>
                                <tr>
                                <tr>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="post" action="">
                                                    ...
                                                    <input type="hidden" value="<?= $datas["data"]["id"] ?>" class="form-control" name="idBonDeLivraison">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="post" action="">
                                                    <div class="form-group">
                                                        <label for="recipient-name" class="control-label">Voulez-vous Supprimer <b><?= htmlspecialchars($repository["serviceDetail"]["designation"]) ?></b>?</label>
                                                        <input type="hidden" value="<?= $repository["id"] ?>" class="form-control"  name="id">
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Annuler</button>
    ...
    <div id="responsive-modal-ajouter" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="">
                        <input type="hidden" value="<?= $datas["data"]["id"] ?>" class="form-control" id="idBonDeLivraison" name="idBonDeLivraison">
                        <div class="form-group">
    ...
    <?php
        ...
        if (isset($_POST['ajouter'])) 
        {
            ...
            curl_setopt($ch, CURLOPT_URL, "https://spectacular-reprieve-production.up.railway.app/facturation/api/gestion_de_bon_de_livraison/ajout_detail");
        ...
        if (isset($_POST['modifier'])) 
        {
            ...
            curl_setopt($ch, CURLOPT_URL, "https://spectacular-reprieve-production.up.railway.app/facturation/api/gestion_de_bon_de_livraison/modefier_detail/{$_POST['id']}");
            curl_setopt($ch, CURLOPT_HTTPHEADER, $headers);
        ...
        if (isset($_POST['supprimer'])) 
        {
            ...
            curl_setopt($ch, CURLOPT_URL, "https://spectacular-reprieve-production.up.railway.app/facturation/api/gestion_de_bon_de_livraison/delete_detail/{$_POST['id']}");
            curl_setopt($ch, CURLOPT_HTTPHEADER, $headers);
