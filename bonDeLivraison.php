<?php
    ...
    $ch = curl_init();
    $url = "http://localhost:8085/facturation/api/gestion_de_bon_de_livraison/";
...
<?php
    ...
    if (isset($_POST['ajouter'])) 
    {
        ...
        curl_setopt($ch, CURLOPT_URL, "http://127.0.0.1:8085/facturation/api/gestion_de_bon_de_livraison/");
    ...
    if (isset($_POST['modifier'])) 
    {
        ...
        curl_setopt($ch, CURLOPT_URL, "http://127.0.0.1:8085/facturation/api/gestion_de_bon_de_livraison/{$_POST['id']}");
        curl_setopt($ch, CURLOPT_HTTPHEADER, $headers);
