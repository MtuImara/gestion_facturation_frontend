<?php
    ...
    $ch = curl_init();
    $url = "https://spectacular-reprieve-production.up.railway.app/facturation/api/gestion_de_bon_de_livraison/";
...
<body>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                <h3 class="box-title m-b-0">Listes des Bons de Livraison</h3>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-nowrap">
                                    <a href="bonDeLivraisonDetail.php?id=<?= $repository["id"] ?>" data-toggle=""  data-original-title="Detail"> <i class="fa fa-book text-inverse m-r-10"></i> </a>
                                    <a href="bonDeLivraisonAfficher.php?id=<?= $repository["id"] ?>" data-toggle=""  data-original-title="Voir"> <i class="fa fa-file-pdf-o text-inverse m-r-10"></i> </a>
...
<?php
    ...
    if (isset($_POST['ajouter'])) 
    {
        ...
        curl_setopt($ch, CURLOPT_URL, "https://spectacular-reprieve-production.up.railway.app/facturation/api/gestion_de_bon_de_livraison/");
    ...
    if (isset($_POST['modifier'])) 
    {
        ...
        curl_setopt($ch, CURLOPT_URL, "https://spectacular-reprieve-production.up.railway.app/facturation/api/gestion_de_bon_de_livraison/{$_POST['id']}");
        curl_setopt($ch, CURLOPT_HTTPHEADER, $headers);
