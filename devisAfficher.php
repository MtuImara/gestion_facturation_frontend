                        ...
                        <div class="white-box printableArea">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="pull-right text-right">
                                        <address>
                                            ...
                                            <p><b>Date de création :</b> <i class="fa fa-calendar"></i> 
                                                <?= htmlspecialchars($datas["data"]["dateCreation"]) ?>
                                            </p>
                                        </address>
                                    </div>
                                ...
                                <div class="pull-center">
                                    <address>
                                        <h3><b class="text-primary">D2S SERVICES DEVIS <?= htmlspecialchars($datas["data"]["code"]) ?></b></h3>
                                    </address>
                                </div>
                                <div class="col-md-12">
