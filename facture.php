...
<body>
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-9 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">D2S Service Facture</h4>
                    </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                <h3 class="box-title m-b-0">Listes des Factures</h3>
                    ...
                    <table id="example23" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= htmlspecialchars($repository["dateEcheance"]) ?></td>
                                <td><?= $repository["montantTotalHT"] ?></td>
                                <td><?= htmlspecialchars($repository["etat"]) ?></td>
                                <td class="text-nowrap">
                                <a href="factureDetail.php?id=<?= $repository["id"] ?>" data-toggle=""  data-original-title="Detail"> <i class="fa fa-book text-inverse m-r-10"></i> </a>
                                    <a href="factureAfficher.php?id=<?= $repository["id"] ?>" data-toggle=""  data-original-title="Voir"> <i class="fa fa-file-pdf-o text-inverse m-r-10"></i> </a>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form method="post" action="">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="recipient-name" class="control-label">Date d'Echéance:</label>
                                                        <input type="datetime-local" value="<?= $repository["dateEcheance"] ?>" class="form-control" id="dateEcheance" name="dateEcheance">
                                                    </div>
                                                    <!-- <div class="form-group">
