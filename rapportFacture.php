<?php
    ...
    $ch = curl_init();
    $url = "https://spectacular-reprieve-production.up.railway.app/facturation/api/rapport_facture/";
...
<body>
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-9 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">D2S Services Facture</h4>
                    </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                <h3 class="box-title m-b-0">Rapport des Factures</h3>
                ...
                <div class="table-responsive">
                    <table id="example23" class="table table-striped">
                        ...
                        <tbody>
                            <?php 
                                foreach ($datas["data"]["rapportFacture"] as $repository){

                                    foreach ($repository["factureDetail"] as $detail){
                            ?>
                            <tr>
                                <td><?= htmlspecialchars($detail["facture"]["dateOperation"]) ?></td>
                                <td><?= htmlspecialchars($detail["facture"]["code"]) ?></td>
                                ...
                                <td><?= htmlspecialchars($detail["facture"]["dateEcheance"]) ?></td>
                                <td><?= htmlspecialchars($detail["facture"]["etat"]) ?></td>                              
