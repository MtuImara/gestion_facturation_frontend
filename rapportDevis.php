<?php
    ...
    $ch = curl_init();
    $url = "https://spectacular-reprieve-production.up.railway.app/facturation/api/rapport_devis/";
...
<body>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                <h3 class="box-title m-b-0">Rapport des Devis</h3>
                ...
                <div class="table-responsive">
                    <table id="example23" class="table table-striped">
                        ...
                        <tbody>
                            <?php 
                                foreach ($datas["data"]["rapportDevis"] as $repository){

                                    foreach ($repository["devisDetail"] as $detail){
                            ?>
                            <tr>
                                <td><?= htmlspecialchars($detail["devis"]["dateOperation"]) ?></td>
                                <td><?= htmlspecialchars($detail["devis"]["code"]) ?></td>
                                ...
                                <td><?= htmlspecialchars($detail["devis"]["etat"]) ?></td>                              
