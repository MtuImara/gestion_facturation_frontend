...
?>
    ...
    <div class="row bg-title">
        <div class="col-lg-9 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">D2S Services Unités de Mésure</h4>
        </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                <h3 class="box-title m-b-0">Listes des Unités de Mésure</h3>
                    ...
                    <table id="example23" class="table table-striped">
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= htmlspecialchars($repository["valeur"]) ?></td>
                                <td class="text-nowrap">
                                    <a href="#" data-toggle="modal" data-target="#responsive-modal<?=$i?>" data-original-title="Modifier"> <i class="fa fa-pencil text-inverse m-r-10"></i> </a>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="post" action="uniteMesureAjout.php">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="recipient-name" class="control-label">Valeur:</label>
                                ...
                                <div id="responsive-modal<?=$i?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="post" action="uniteMesureUpdate.php">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="<?= $repository["valeur"] ?>" class="form-control" id="valeur" name="valeur">
                                                    </div>
                                ...
                                <div id="responsive-modal1<?=$i?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="post" action="uniteMesureDelete.php">
                                                    <div class="form-group">
