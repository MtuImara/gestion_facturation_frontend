<?php
    ...
    $ch = curl_init();
    $url = "https://spectacular-reprieve-production.up.railway.app/facturation/api/gestion_de_bon_de_commande/";
...
<body>
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-9 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">D2S Services Bon de Commande</h4>
                    </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                <h3 class="box-title m-b-0">Listes des Bons de Commande</h3>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-nowrap">
                                    <a href="bonDeCommandeDetail.php?id=<?= $repository["id"] ?>" data-toggle=""  data-original-title="Detail"> <i class="fa fa-book text-inverse m-r-10"></i> </a>
                                    <a href="bonDeCommandeAfficher.php?id=<?= $repository["id"] ?>" data-toggle=""  data-original-title="Voir"> <i class="fa fa-file-pdf-o text-inverse m-r-10"></i> </a>
...
<?php
    ...
    if (isset($_POST['ajouter'])) 
    {
        ...
        curl_setopt($ch, CURLOPT_URL, "https://spectacular-reprieve-production.up.railway.app/facturation/api/gestion_de_bon_de_commande/");
    ...
    if (isset($_POST['modifier'])) 
    {
        ...
        curl_setopt($ch, CURLOPT_URL, "https://spectacular-reprieve-production.up.railway.app/facturation/api/gestion_de_bon_de_commande/{$_POST['id']}");
        curl_setopt($ch, CURLOPT_HTTPHEADER, $headers);
