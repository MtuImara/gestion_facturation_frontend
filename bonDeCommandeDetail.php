...
<?php
    ...
    $id = $_GET["id"];
    $ch = curl_init();
    $url = "http://127.0.0.1:8085/facturation/api/gestion_de_bon_de_commande/$id";
...
?>
    ...
    <?php
        ...
        if (isset($_POST['ajouter'])) 
        {
            ...
            curl_setopt($ch, CURLOPT_URL, "http://127.0.0.1:8085/facturation/api/gestion_de_bon_de_commande/ajout_detail");
        ...
        if (isset($_POST['modifier'])) 
        {
            ...
            curl_setopt($ch, CURLOPT_URL, "http://127.0.0.1:8085/facturation/api/gestion_de_bon_de_commande/modefier_detail/{$_POST['id']}");
            curl_setopt($ch, CURLOPT_HTTPHEADER, $headers);
        ...
        if (isset($_POST['supprimer'])) 
        {
            ...
            curl_setopt($ch, CURLOPT_URL, "http://127.0.0.1:8085/facturation/api/gestion_de_bon_de_commande/delete_detail/{$_POST['id']}");
            curl_setopt($ch, CURLOPT_HTTPHEADER, $headers);
