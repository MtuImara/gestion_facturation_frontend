...
<?php
    ...
    $id = $_GET["id"];
    $ch = curl_init();
    $url = "https://spectacular-reprieve-production.up.railway.app/facturation/api/gestion_de_bon_de_commande/$id";
...
?>
            ...
            <div class="white-box">
                ...
                <div class="table-responsive">
                    <table class="table color-table primary-table">
                        ...
                        <?php 
                            $i=0;
                            foreach ($datas["data"]["bonDeCommandeDetail"] as $repository): 
                            $i++;
                        ?>
                                <tr>
                                <tr>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="post" action="">
                                                    ...
                                                    <input type="hidden" value="<?= $datas["data"]["id"] ?>" class="form-control" name="idBonDeCommande">
    ...
    <div id="responsive-modal-ajouter" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="">
                        <input type="hidden" value="<?= $datas["data"]["id"] ?>" class="form-control" id="idBonDeCommande" name="idBonDeCommande">
                        <div class="form-group">
    ...
    <?php
        ...
        if (isset($_POST['ajouter'])) 
        {
            ...
            curl_setopt($ch, CURLOPT_URL, "https://spectacular-reprieve-production.up.railway.app/facturation/api/gestion_de_bon_de_commande/ajout_detail");
        ...
        if (isset($_POST['modifier'])) 
        {
            ...
            curl_setopt($ch, CURLOPT_URL, "https://spectacular-reprieve-production.up.railway.app/facturation/api/gestion_de_bon_de_commande/modefier_detail/{$_POST['id']}");
            curl_setopt($ch, CURLOPT_HTTPHEADER, $headers);
        ...
        if (isset($_POST['supprimer'])) 
        {
            ...
            curl_setopt($ch, CURLOPT_URL, "https://spectacular-reprieve-production.up.railway.app/facturation/api/gestion_de_bon_de_commande/delete_detail/{$_POST['id']}");
            curl_setopt($ch, CURLOPT_HTTPHEADER, $headers);
