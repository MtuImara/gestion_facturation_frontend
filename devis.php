<?php
    ...
    $ch = curl_init();
    $url = "https://spectacular-reprieve-production.up.railway.app/facturation/api/gestion_de_devis/";
...
<?php
    ...
    if (isset($_POST['ajouter'])) 
    {
        ...
        curl_setopt($ch, CURLOPT_URL, "https://spectacular-reprieve-production.up.railway.app/facturation/api/gestion_de_devis/");
    ...
    if (isset($_POST['modifier'])) 
    {
        ...
        curl_setopt($ch, CURLOPT_URL, "https://spectacular-reprieve-production.up.railway.app/facturation/api/gestion_de_devis/{$_POST['id']}");
        curl_setopt($ch, CURLOPT_HTTPHEADER, $headers);
